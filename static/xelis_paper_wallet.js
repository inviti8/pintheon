...
(function() {
     ...
     * @returns {(string)[]}
     */
    __exports.get_languages = function() {
     ...
     * @param {number} ptr
     */
    __exports.task_worker_entry_point = function(ptr) {
...
class KeyPair {
     ...
     */
    constructor(mainnet) {
        const ret = wasm.keypair_new(mainnet);
     ...
     */
    seed(language_id) {
        const ret = wasm.keypair_seed(this.__wbg_ptr, language_id);
        if (ret[3]) {
